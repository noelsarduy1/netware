                ...
                <div className="container">
                    <div className="movieInfo">
                        ...
                        <p className="statistical">
                            ...
                            <span className="popularity">Views:  {movie && movie.popularity}</span>
                        </p>
                        <p className="releaseDate">Release Date: {movie && (moment(movie.release_date).format('DD/MM/YYYY') || moment(movie.first_air_date).format('DD/MM/YY'))}</p>
                        <p className="runtime">Runtime: {movie && ( movie.runtime || movie.episode)}</p>
